...
public class RentBook extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oprice.setText(String.format("%s KES", String.valueOf(sprice)));
        ogenre.setText("");
        oitemprice.setText(String.format("%s KES", String.valueOf(sprice)));
        odeliprice.setText(String.format("%s KES", String.valueOf(dprice)));
        //total=sprice+dprice;
        ototalprice.setText(String.format("%s KES", String.valueOf(total)));
        famount.setText(String.format("KES %s", String.valueOf(total)));
