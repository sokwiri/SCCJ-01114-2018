...
public class HomecFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        sliderModels.add(new SlideModel("https://i.imgur.com/IGIu5Fb.jpg", ScaleTypes.CENTER_INSIDE));
        sliderModels.add(new SlideModel("https://i.imgur.com/PObprBN.jpg",ScaleTypes.CENTER_INSIDE));
        slider.setImageList(sliderModels);
    ...
    private void showNewAvailables() {
        ...
        adapter = new FirestoreRecyclerAdapter<SellingBook, SellingBooksViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NotNull SellingBooksViewHolder viewHolder, int position, @NotNull final SellingBook model) {
                viewHolder.row_price.setText(String.format("%d KES", model.getSellingprice()));
